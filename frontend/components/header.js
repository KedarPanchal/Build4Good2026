            ...
            <nav class="nav-capsule flex justify-between items-center px-8 py-2.5 w-full max-w-4xl rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.1)]">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button onclick="window.location.href='search.html'" class="bg-gradient-to-r from-primary to-[#f2cf66] text-black font-bold px-4 py-1.5 rounded-full text-xs uppercase tracking-wider transition-all duration-400 active:scale-95 shadow-lg shadow-primary/10">
                            Try Now
                        </button>
                    </div>
                </div>
